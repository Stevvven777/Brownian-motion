...
当前四颗粒子的全轨迹参考扩散系数 $D_{\mathrm{ref}}$ 与理论 Stokes--Einstein 期望值 $D_{\mathrm{expect}}$ 的比较如下：
...
可以看到，粒子 1 与理论值基本接近；粒子 2、3、4 的 $D_{\mathrm{ref}}$ 明显偏大，分别约为理论值的 $1.23$ 倍、$1.25$ 倍和 $2.20$ 倍。
...
\begin{enumerate}[leftmargin=2em]
  ...
  \item \textbf{有限轨迹长度与非平稳性：} 粒子 2 和粒子 3 的布朗轨迹长度明显短于粒子 1，统计平均不充分；粒子 4 虽然轨迹较长，但全局漂移更强。
